...
const CODE_MESSAGES = {
  ...
  "C++ server unreachable": "File server is unavailable. Please try again later.",
  "File server unavailable": "File server is unavailable. Please try again later.",
  "Query is required": "Please enter a search term.",
  "Malformed query": "Search query is invalid.",
  "Invalid file id": "Item not found.",
  "Invalid item id": "Item not found.",
  "File not found": "Item not found.",
  "Parent not found": "Folder not found.",
  ...
  "invalid email or password format": "Invalid email or password format.",
